...
<div class="ibp_dashboard_outr">
	<div class="ibp_dashboard_inr">
		...
		<!-- Left side detail starts-->
				<div class="customer_detail col-md-3 col-sm-3 col-xs-10 col-md-offset-1 col-sm-offset-1 col-xs-offset-1 margin_top_85px margin_botm_80px">
		...
		<!-- Right side detail starts-->
			<div class="col-md-6 col-sm-6 col-xs-10 col-md-offset-1 col-sm-offset-1 col-xs-offset-1  margin_top_70px margin_botm_100px">	
				<div class="panel-body row">
					<form class="form-horizontal padd_left_right_all_zero basic_info_form" role="form" method="POST">
						<div class="detail_form_outr col-md-12 col-sm-12 col-xs-12">
							<div class="form-group margin_top_35px">
								<div class="col-md-3 col-sm-4 col-xs-5 padd_left_zero">
									<label>Name :</label>
								</div>
                            ...
                            <div class="form-group margin_top_35px">
                                ...
                                <div class="col-md-8 col-sm-7 col-xs-6 expertise_align">
                            ...
                            <div class="form-group margin_top_35px margin_botm_40px">
								<div class="col-md-3 col-sm-4 col-xs-5 padd_left_zero">
									<label>About :</label>
								</div>
                                <div class="col-md-9 col-sm-8 col-xs-7 padd_right_zero">
                    	...
                    	<div class="first_cont_btn col-md-12 col-sm-12 col-xs-12 padd_right_zero">
                            <div class="form-group margin_top_50px">
